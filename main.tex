...
\affil[1]{\texttt{412580084@cloud.fju.edu.tw} (Y.-L. Tsai);\quad \texttt{412580292@cloud.fju.edu.tw} (Y.-L. Cheng);\quad \texttt{412580060@cloud.fju.edu.tw} (Y.-Y. Huang)}
\affil[2]{International Cybersecurity Talent Development and Promotion Association}
\affil[2]{\texttt{chmao2008@gmail.com} (C.-H. Mao)}
